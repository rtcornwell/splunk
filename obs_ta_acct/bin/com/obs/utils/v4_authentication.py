...
from com.obs.log.log_client import DEBUG
...
class V4Authentication(object):
    ...
    def v4Auth(self, method, bucket, key, args_path, headers):
        ...
        signature = self.getSignature(method, bucket, key, args_path, headers)
    ...
    def getCanonicalRequest(self, method, bucket, key, args_path, headers, payload=None):
        outPut = method + '\n'
        outPut += self.getCanonicalURI(bucket, key) + '\n'
